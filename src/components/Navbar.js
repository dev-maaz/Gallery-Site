...
function Navbar () {
    ...
    <div className="navbar surface">
        ...
        <Link className='navitem focus-visible:outline-none' to="/">
            {/* <img src="home-logo.png" style={navbarIcons} alt="home-logo" /> */}
            <span class="material-symbols-outlined"> home </span>
            Home
        </Link>
        <Link className='navitem focus-visible:outline-none' to="/items">
            {/* <img src="items-logo.png" style={navbarIcons} alt="items-logo" /> */}
            <span class="material-symbols-outlined"> photo_library </span>
            Items
        </Link>
        <Link className='navitem focus-visible:outline-none' to="/tasks">
            {/* <img src="tasks-logo.png" style={navbarIcons} alt="tasks-logo" /> */}
            <span class="material-symbols-outlined"> inventory </span>
            Tasks
        </Link>
        <Link className='navitem focus-visible:outline-none' to="/contact">
